...
#include <motion_primitive_library/common/math.h>
...
class LambdaSeg {
 public:
  ...
  LambdaSeg(const VirtualPoint& v1, const VirtualPoint& v2) {
    Mat4f A;
    A << power(v1.t, 3), v1.t * v1.t, v1.t, 1, 3 * v1.t * v1.t, 2 * v1.t, 1,
      0, power(v2.t, 3), v2.t * v2.t, v2.t, 1, 3 * v2.t * v2.t, 2 * v2.t, 1,
      0;
    Vec4f b;
  ...
  decimal_t getT(decimal_t t) const {
    return a(0) / 4 * power(t, 4) + a(1) / 3 * power(t, 3) +
      a(2) / 2 * t * t + a(3) * t;
  }
